...
@section('actions')
    <a href="{{ route('subscriptions.index') }}" class="btn btn-primary btn-sm btn-icon-split">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="icon" name="icon" rows="3">{{ old('icon', $subscription->icon) }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    <label>سقف خدمات</label>
                    <input type="number" name="service_limit" class="form-control" required
                        value="{{ old('service_limit', $subscription->service_limit) }}">
                </div>
