                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-3">
                        ...
                        <select name="access" id="access" class="form-control @error('access') is-invalid @enderror">
                            <option value="public" {{ $discount->access === 'public' ? 'selected' : '' }}>عمومی</option>
                            <option value="private" {{ $discount->access === 'private' ? 'selected' : '' }}>خصوصی</option>
                        </select>
                        @error('access')
                    ...
                    <div class="col-lg-4 mb-3">
                        ...
                        <select name="limitdiscount" id="limitdiscount"
                            ...
                            <option value="0" {{ $discount->limitdiscount == 0 ? 'selected' : '' }}>نامحدود</option>
                            @for ($i = 1; $i <= 10; $i++)
                                <option value="{{ $i }}"
                    ...
                    <div class="col-lg-4 mb-3">
                        ...
                        <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                            <option value="amount" {{ $discount->getRawOriginal('type') === 'amount' ? 'selected' : '' }}>
                                مبلغی</option>
                            <option value="percent"
                                {{ $discount->getRawOriginal('type') === 'percent' ? 'selected' : '' }}>درصدی</option>
                        </select>
                        @error('type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <input type="number" name="amount" id="amount" value="{{ old('amount', $discount->amount) }}"
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <input type="text" name="expiration" id="expiration"
                            value="{{ old('expiration', $discount->expiration) }}"
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <select name="status" id="status" class="form-control @error('status') is-invalid @enderror">
                            <option value="disable"
                                {{ $discount->getRawOriginal('status') === 'disable' ? 'selected' : '' }}>غیرفعال</option>
                            <option value="enable"
                                {{ $discount->getRawOriginal('status') === 'enable' ? 'selected' : '' }}>فعال</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
