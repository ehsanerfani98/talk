...
@section('name', 'ویرایش اسلاید')
@section('actions')
    <a href="{{ route('sliders.index') }}" class="btn btn-primary btn-sm btn-icon-split">
    ...
    <form method="POST" action="{{ route('sliders.update', $slider->id) }}" enctype="multipart/form-data">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">جزئیات اسلاید</h6>
            </div>
            <div class="card-body">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control" name="link" value="{{ old('link', $slider->link) }}">
                </div>
                <div class="mb-3">
