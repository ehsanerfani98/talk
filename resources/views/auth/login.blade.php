    ...
    <div class="login-container">
        <div class="banner-section">
            ...
            <div class="banner-content">
                <div class="company-logo">
                    ...
                    <img src="{{ asset('admin/img/logo.webp') }}" alt="logo" />
                </div>
                <p class="banner-text" style="margin-bottom: 0">به سامانه تاک خوش آمدید.
                <p class="banner-text" style="font-size: 15px">جهت ورود به سامانه تاک، لطفا از کد یکبار مصرف استفاده
                    نمایید.
            </div>
        </div>
        ...
        <div class="form-section">
            <div class="form-header">
                <h2 class="form-title">ورود به سامانه تاک</h2>
                ...
                Notification.requestPermission().then(function(permission) {
                    if (permission === "granted") {
                        new Notification("کد تایید", {
                            body: code,
                            icon: "https://cdn-icons-png.freepik.com/256/13636/13636259.png?semt=ais_hybrid"
                        });
                    }
                });
            }
